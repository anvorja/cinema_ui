...
//   } = useFilterOptions();
//
//   // 🎯 FILTROS EN CASCADA: Opciones filtradas según selecciones previas
//   const brandOptions = getBrandOptions(true);
//   const modelOptions = getFilteredOptions ? getFilteredOptions('models', filters) : getModelOptions(true);
//   const colorOptions = getFilteredOptions ? getFilteredOptions('colors', filters) : getColorOptions(true);
//   const yearOptions = getFilteredOptions ? getFilteredOptions('years', filters) : getYearOptions(true);
//
//   // 🎯 LÓGICA MEJORADA PARA RANGO DE AÑOS
//   const generateYearRangeOptions = (isMaxYear = false) => {
//     const currentYear = new Date().getFullYear();
...
//   const yearRangeToOptions = generateYearRangeOptions(true);
//
//   // Manejar cambios en filtros con validación y limpieza de dependientes
//   const handleFilterChange = (field, value) => {
//     onFiltersChange(prev => {
//       const newFilters = { ...prev, [field]: value };
//
...
//       }
//
//       // 🎯 NUEVAS VALIDACIONES PARA FILTROS EN CASCADA
//
//       // 5. Si se cambia la marca, limpiar modelo/año/color dependientes
//       if (field === 'brand') {
//         if (!value) {
//           // Si se limpia la marca, mantener otros filtros
//         } else {
//           // Si se cambia a otra marca, limpiar filtros dependientes
//           if (prev.brand && prev.brand !== value) {
//             newFilters.model = '';
//             newFilters.year = '';
//             newFilters.color = '';
//             newFilters.minYear = '';
...
//       }
//
//       // 6. Si se cambia el modelo, limpiar año/color dependientes
//       if (field === 'model') {
//         if (!value) {
//           // Si se limpia el modelo, mantener otros filtros
//         } else {
//           // Si se cambia a otro modelo, limpiar filtros dependientes
//           if (prev.model && prev.model !== value) {
//             newFilters.year = '';
//             newFilters.color = '';
//             newFilters.minYear = '';
//             newFilters.maxYear = '';
...
//   } = useFilterOptions();
//
//   // 🎯 FUNCIÓN PARA FILTRAR OPCIONES EN CASCADA REAL
...
//     }
//
//     // Filtrar carros según filtros actuales
//     let filteredCars = [...allCars];
//
//     // Aplicar filtros previos para obtener opciones relevantes
...
//     switch (type) {
//       case 'brands':
//         uniqueValues = [...new Set(allCars.map(car => car.brand).filter(Boolean))];
//         break;
//       case 'models':
...
//       models: filters.brand ? `Todos los modelos de ${filters.brand}` : 'Todos los modelos',
