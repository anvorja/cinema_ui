...
//             <div className="flex items-start justify-between mb-4">
//                 <div className="flex-1">
//                     {/* Imagen del auto - AHORA CLICKEABLE */}
//                     {car.photo_url ? (
//                         <div
//                             className="w-16 h-16 rounded-xl overflow-hidden mb-3 shadow-lg ring-2 ring-white/20 dark:ring-white/10 cursor-pointer hover:ring-4 hover:ring-blue-500/50 transition-all duration-300 group/image"
...
//                             />
//                             {/* Overlay con icono de zoom que aparece al hover */}
...
//     onEdit: PropTypes.func.isRequired,
//     onDelete: PropTypes.func.isRequired,
//     onImagePreview: PropTypes.func, // Nueva prop opcional
// };
//
// export default CarCard;


// src/components/cars/CarCard.jsx - CON HOVER EFFECT RESTAURADO
import { useState } from 'react';
import PropTypes from 'prop-types';
import {
    EyeIcon,
...
//             <div className="flex items-start justify-between mb-4">
//                 <div className="flex-1">
//                     {/* Imagen del auto - SOLO AGREGAR CLICKEABLE */}
//                     {car.photo_url ? (
//                         <div
//                             className="w-16 h-16 rounded-xl overflow-hidden mb-3 shadow-lg ring-2 ring-white/20 dark:ring-white/10 cursor-pointer hover:ring-4 hover:ring-blue-500/50 transition-all duration-300 group/image relative"
//                             onClick={handleImageClick}
...
// };
//
// // PropTypes para validación - MANTENER COMPATIBILIDAD
// CarCard.propTypes = {
//     car: PropTypes.shape({
//         car_id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
//         brand: PropTypes.string.isRequired,
...
//     onEdit: PropTypes.func.isRequired,
//     onDelete: PropTypes.func.isRequired,
//     onImagePreview: PropTypes.func, // OPCIONAL - no rompe compatibilidad
// };
//
// export default CarCard;