...
//   };
//
//   const InputField = ({ label, name, type = 'text', placeholder, icon, showPasswordToggle = false }) => (
...
//               <EyeSlashIcon className="w-4 h-4 text-gray-300 group-hover:text-blue-400 transition-colors" />
//             ) : (
//               <EyeIcon className="w-4 h-4 text-gray-300 group-hover:text-blue-400 transition-colors" />
//             )}
//           </button>
//         )}
//
...
//           <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-green-500 via-blue-600 to-purple-500 shadow-2xl mb-6 animate-glow">
