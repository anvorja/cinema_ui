...
// import PaginationControls from '../components/ui/PaginationControls';
// import Modal from '../components/ui/Modal';
// import ImagePreviewModal from '../components/ui/ImagePreviewModal'; // SOLO ESTA LÍNEA ES NUEVA
// import { Search, Filter, BarChart3, Sparkles } from 'lucide-react';
//
// const GlassCard = ({ children, className = "", hover = true, ...props }) => {
//     return (
...
//     const [showStats, setShowStats] = useState(false);
//
//     // SOLO ESTOS 3 ESTADOS SON NUEVOS - para el modal de imagen
//     const [showImagePreview, setShowImagePreview] = useState(false);
//     const [previewImageUrl, setPreviewImageUrl] = useState('');
//     const [previewCarInfo, setPreviewCarInfo] = useState(null);
//
//     const { showToast } = useToast();
//
//     // SOLO ESTAS 2 FUNCIONES SON NUEVAS - para el modal de imagen
//     const handleImagePreview = (imageUrl, carInfo) => {
//         setPreviewImageUrl(imageUrl);
//         setPreviewCarInfo(carInfo);
//         setShowImagePreview(true);
...
//     }, []);
//
//     // SOLO ESTE useEffect ES NUEVO - para manejar tecla Escape
//     useEffect(() => {
//         const handleEscapeKey = (event) => {
//             if (event.key === 'Escape' && showImagePreview) {
//                 handleCloseImagePreview();
...
//                                             onEdit={handleEdit}
//                                             onDelete={handleDelete}
//                                             onImagePreview={handleImagePreview} // SOLO ESTA LÍNEA ES NUEVA
//                                         />
//                                     ))}
//                                 </div>
//
