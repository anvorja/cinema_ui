...
//
//     // 🔥 NUEVO ESTADO: Controla si ya pasó el delay mínimo
...
//
//     // 🔥 FUNCIÓN PARA RECARGAR AUTOS (sin loading)
//     const reloadCars = useCallback(async () => {
//         try {
//             const response = await carService.getAll();
//             setCars(response.data.data || []);
//         } catch (error) {
//             console.error('Error recargando autos:', error);
//         }
//     }, []);
//
//     // 🔥 DELAY MÍNIMO SEPARADO
//     useEffect(() => {
//         const timer = setTimeout(() => {
//             setMinDelayPassed(true);
//         }, 500); // 500ms para garantizar que se vea el spinner
//
...
//                     carService.getAll(),
//                     carService.getStats().catch(error => {
...
//     }, [showToast]);
//
//     // Aplicar filtros y búsqueda - SOLO cuando no esté cargando
//     useEffect(() => {
...
//     }, [cars, searchTerm, filters, loading, minDelayPassed]);
//
//     // Funciones de manejo
//     const clearFilters = () => {
//         setFilters({
...
//     };
//
//     const shouldShowLoading = loading || !minDelayPassed;
//
//     return (
...
//                         {cars.length > 0 && filteredCars !== null && (
//                             <div className="mb-6">
...
//                         )}
//
//                         {/* Estados de contenido - SOLO si ya se procesaron los filtros */}
//                         {filteredCars === null ? (
//                             // Aún procesando filtros
