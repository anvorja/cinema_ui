...
export const useMovies = (options: Record<string, any> = {}) => {
  ...
  const fetchMovies = useCallback(async (params: Record<string, any> = {}) => {
    setLoading(true);
    setError(null);
...
export const useMovieShowtimes = (movieId: any, options: Record<string, any> = {}) => {
